                ...
                <form action="" method="post" id="fileForm" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="mt-1 d-flex justify-content-center gap-2">
                      <input type="radio" class="btn-check me-2" name="account" id="paceint" value="0" autocomplete="off" checked>
                  ...
                  <div class="form-group">
                    ...
                    <input required name="pass1" type="password" class="form-control inputpass" minlength="4" maxlength="16"  id="pass1" onkeyup="checkFirstPass();"/> </p>
                    <span id="errPass1"></span>
                    </div>
                    
                    <div class="form-group mt-2">
                    <label for="pass2">Confirm password: </label>
                    <input required name="pass2" type="password" class="form-control inputpass" minlength="4" maxlength="16" placeholder="Enter again to validate"  id="pass2" onkeyup="checkSecondPass();" />
                  ...
                  <div class="form-group mt-4 d-flex justify-content-center">
                    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-success btn-lg" onclick="register_click();">Register</button>
                  </div>
